...
classdef imageSet
    ...
    methods (Access = public)
        ...
        function imOut = read(this, index)
            ...
            try
                ...
                % indicate which file could not be read, in addition to the
                % error message from imread
        ...
        function out = select(this, index)
            ...
            out(n) = imageSet(this(end).ImageLocation(index));
            out(n).Description = this(end).Description;
            for i = 1:n-1
                out(i) = imageSet(this(i).ImageLocation(index));
    ...
    methods (Static, Hidden)
        ...
        function this = loadobj(that)
            this = imageSet(that.ImageLocation);
